...
def get_adapted_clip(
    ...
    Args:
        ...
        model_type: Type of prompt learning ('ivlp', 'coop', or 'maple')
    ...
    model_types = {
        "ivlp": "src.models.architecture.ivlp",
        "coop": "src.models.architecture.coop",
    ...
    if model_type == "coop":
        model.prompt_learner.load_state_dict(model_statedict, strict=False)
    else:
